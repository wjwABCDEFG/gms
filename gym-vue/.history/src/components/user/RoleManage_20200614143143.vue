    ...
    <el-card>
      ...
      <el-table :data="tableData"  style="width: 75%;text-align:center;font-size:15px">
        ...
        <el-table-column align="center" label="操作">
          <template>
            <el-button type="text" size="medium" @click="dialogFormVisible = true">修改</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    async getUserList(){
      ...
      this.tableData.role_id = "yong";
      switch(res.data.role_id){
        case 1: this.tableData.role_id="用户管理员";
        case '2': this.tableData.role_id="用户管理员";
      };
    }
  }
};
