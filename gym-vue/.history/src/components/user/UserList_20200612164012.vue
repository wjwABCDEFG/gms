  ...
  <div>
    ...
    <el-card>
      ...
      <el-table  :data="tableData"  style="width: 75%;text-align:center;font-size:15px">
        <el-table-column align="center" label="用户id" prop="num"></el-table-column>
        <el-table-column align="center" label="用户名" prop="class"></el-table-column>
        <el-table-column align="center" label="真实姓名" prop="position"></el-table-column>
        <el-table-column align="center" label="邮箱" prop="time"></el-table-column>
        <el-table-column align="center" label="电话" prop=""><el-tag>运行中</el-tag></el-table-column>
      </el-table>
