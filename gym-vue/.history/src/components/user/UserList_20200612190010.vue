<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 用户列表 -->
      <el-table :ref="UserListRef" :data="tableData"  style="width: 75%;text-align:center;font-size:15px">
        ...
        <el-table-column align="center" label="信用" prop="credit"></el-table-column>
      </el-table>
